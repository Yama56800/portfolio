...
export default function Projets() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Oh My Food est un site de réservation de menus en ligne pour différents restaurants, créé en utilisant HTML et SCSS. Pendant la conception de ce site, j'ai acquis de nouvelles compétences, notamment en matière d'animations, de boutons animés, d'icônes animées et même de rotations.",
    ...
    },
    {
      ...
      description:
        "Print it!, un site d'entreprise d'impression, a été conçu en utilisant HTML et CSS. Lors de mon intervention sur leur site, j'ai intégré un carrousel en JavaScript avec des points cliquables et des flèches pour diriger le carrousel. Chaque diapositive défile automatiquement.",
